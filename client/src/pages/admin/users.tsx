...
export function AdminUsers() {
    ...
    const handleLock = async (userId: string) => {
        try {
            await api.post(`/admin/users/${userId}/lock`, { durationMinutes: 60 });
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="relative">
                                    ...
                                    <Input placeholder="Search users..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-8 w-64" />
                                </div>
                            </div>
                        </div>
                    </CardHeader>
                                        ...
                                        <div key={user.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {user.lockedOut && <Badge variant="secondary">Locked</Badge>}
