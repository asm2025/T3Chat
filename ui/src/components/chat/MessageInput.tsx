                        ...
                        <div className="mt-2 -mb-px flex w-full min-w-0 flex-row-reverse flex-wrap items-center justify-between gap-2">
                            <div className="-mt-0.5 -mr-0.5 flex shrink-0 items-center justify-center gap-2" aria-label="Message actions">
                                <button
                                    ...
                                    className="focus-visible:ring-ring button-reflect inline-flex size-10 items-center justify-center rounded-lg bg-[rgb(162,59,103)] p-2 text-pink-50 shadow-sm transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 hover:bg-[#d56698]">
