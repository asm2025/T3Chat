        ...
        <div className="flex flex-col gap-2.5 pt-4">
          {prompts.map((prompt) => (
            <Button
              key={prompt}
              variant="ghost"
              className="h-auto justify-start rounded-lg border border-border bg-background px-4 py-3 text-left text-sm font-normal text-muted-foreground hover:border-foreground/20 hover:bg-muted hover:text-foreground"
