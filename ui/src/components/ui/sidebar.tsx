...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
    return <div data-slot="sidebar-header" data-sidebar="header" className={cn("flex flex-col gap-2 p-2", "group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:[&>*]:hidden", className)} {...props} />;
}
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
    return <ul data-slot="sidebar-menu-sub" data-sidebar="menu-sub" className={cn("border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-0.5 border-l px-2.5 py-0", "group-data-[collapsible=icon]:hidden", className)} {...props} />;
}
