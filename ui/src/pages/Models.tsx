            ...
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">Browse and explore available AI models</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <Card>
                            <CardContent className="pt-6">
                                <div className="text-center py-8 text-muted-foreground">{searchQuery || selectedProvider !== "all" ? "No models found matching your filters" : "No models available"}</div>
                            </CardContent>
                        </Card>
                    ) : (
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
