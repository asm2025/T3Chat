      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A modern, open-source chat platform powered by AI. Connect, collaborate, and create with intelligent conversations.
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Engage in intelligent conversations with state-of-the-art AI models
              </CardDescription>
            </CardHeader>
          </Card>
